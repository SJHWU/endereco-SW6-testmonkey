...
import { shopwareFeedback, validateFieldState } from './fieldValidators.js';
import { swFeedbackSelectors } from '../../src/data/swFeedbackSelectors.js';
...
export async function eMailCorrection(page, emailInput, validEmail) {
  ...
  await shopwareFeedback(page, swFeedbackSelectors.personalMail, false);
}
